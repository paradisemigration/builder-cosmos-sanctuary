...
export const SEOHead = ({
  ...
  const fullTitle = title.includes("VisaConsult")
    ? title
    : `${title} - VisaConsult ${country === "uae" ? "UAE" : "India"}`;
  ...
  return (
    <Helmet>
      ...
      <meta
        ...
        content={`VisaConsult ${country === "uae" ? "UAE" : "India"}`}
      />
...
export const generateCityCategorySEO = (
  city: string,
  category: string,
  country: "india" | "uae" = "india",
) => {
