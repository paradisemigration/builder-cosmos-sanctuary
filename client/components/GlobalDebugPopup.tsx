    ...
    try {
      ...
      const statsPromise = fetch("/api/scraping/stats", {
        ...
        .catch((error) => {
          ...
          return {
            totalBusinesses: fallbackData.totalBusinesses,
            totalImages: fallbackData.totalImages,
            totalReviews: fallbackData.totalReviews,
            averageRating: fallbackData.averageRating,
      ...
      const cityStatsPromise = fetch("/api/city-category-stats", {
        ...
        .catch((error) => {
          ...
          return {
            totalCities: fallbackData.totalCities,
            totalCategories: fallbackData.totalCategories,
          };
        });

      const [stats, cityStats] = await Promise.all([
        statsPromise,
        cityStatsPromise,
      ]);
      ...
      const result = {
        ...
        totalCategories:
          cityStats.totalCategories || fallbackData.totalCategories,
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-sm">
                    <div className="text-center p-2 bg-white rounded border">
                      <div className="text-2xl font-bold text-blue-600">
                        {debugInfo.statistics.totalBusinesses.toLocaleString()}
                      </div>
                    ...
                    <div className="text-center p-2 bg-white rounded border">
                      <div className="text-2xl font-bold text-green-600">
                        {debugInfo.statistics.totalCities}
                      </div>
                      <div className="text-xs text-green-600">Total Cities</div>
                    </div>
                    <div className="text-center p-2 bg-white rounded border">
                      <div className="text-2xl font-bold text-purple-600">
                        {debugInfo.statistics.totalCategories}
                      </div>
                    ...
                    <div className="text-center p-2 bg-white rounded border">
                      <div className="text-2xl font-bold text-red-600">
                        {debugInfo.statistics.totalReviews.toLocaleString()}
                      </div>
                      <div className="text-xs text-red-600">Total Reviews</div>
                    </div>
                    <div className="text-center p-2 bg-white rounded border">
                      <div className="text-2xl font-bold text-indigo-600">
                        {debugInfo.statistics.averageRating.toFixed(1)}
                      </div>
