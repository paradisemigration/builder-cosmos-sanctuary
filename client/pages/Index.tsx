...
export default function Index() {
  ...
  const parseSearchQuery = (query: string) => {
    ...
    // Map search terms to our actual business categories
    const serviceTypeMap = {
      "visit visa": "Visit Visa Specialists",
      "tourist visa": "Visit Visa Specialists",
      "tourism visa": "Visit Visa Specialists",
      "work visa": "Work Visa Consultants",
      "employment visa": "Work Visa Consultants",
      "job visa": "Work Visa Consultants",
      "study visa": "Study Visa Services",
      "student visa": "Study Visa Services",
      "education visa": "Study Visa Services",
      "pr visa": "PR & Citizenship Services",
      "permanent residence": "PR & Citizenship Services",
      "permanent residency": "PR & Citizenship Services",
      citizenship: "PR & Citizenship Services",
      ...
      "passport service": "Visa & Passport Services",
      "passport services": "Visa & Passport Services",
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Immigration Scam Awareness Section - 2nd Priority */}
      <section
        className="py-20 bg-gradient-to-br from-red-50 via-orange-50 to-yellow-50 relative overflow-hidden"
        data-section="scam-awareness"
      >
        {/* Animated Background Elements */}
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute -top-40 -left-40 w-80 h-80 bg-gradient-to-br from-red-200/30 to-orange-200/30 rounded-full blur-3xl animate-float-slow"></div>
          <div className="absolute -bottom-40 -right-40 w-80 h-80 bg-gradient-to-br from-orange-200/30 to-yellow-200/30 rounded-full blur-3xl animate-float-medium"></div>
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-60 h-60 bg-gradient-to-br from-yellow-200/20 to-red-200/20 rounded-full blur-2xl animate-float-fast"></div>
        </div>

        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div
            className={`text-center mb-16 transition-all duration-1000 ${
              visibleSections.includes("scam-awareness")
          ...
          >
            ...
            <div className="inline-flex items-center justify-center mb-8">
              <div className="bg-gradient-to-r from-red-500/20 to-orange-500/20 backdrop-blur-sm border border-red-200 rounded-full px-8 py-4">
                <span className="text-red-700 font-bold text-lg flex items-center gap-3">
            ...
            <h2 className="text-4xl lg:text-6xl font-black text-gray-800 mb-8 leading-tight">
            ...
            <p className="text-xl lg:text-2xl text-gray-600 mb-12 max-w-4xl mx-auto leading-relaxed">
              Be aware of fraudulent immigration companies that prey on people's
              dreams.
              <span className="block mt-2 text-red-600 font-semibold">
                Learn how to identify scams and report suspicious activities to
            ...
            {[
              {
                ...
                description:
                  "Legitimate companies don't demand large upfront payments or fees before starting work. Be suspicious of companies asking for full payment in advance.",
              ...
              },
              {
                ...
                description:
                  "Scammers create fake government stamps, letterheads, and certificates. Always verify documents directly with official sources.",
              ...
              },
              {
                ...
                description:
                  "No legitimate company can guarantee visa approval or processing times. Be wary of promises that seem too good to be true.",
              ...
              {
                icon: "🏢",
                title: "Unlicensed Operations",
                description:
                  "Verify that the company is properly licensed to provide immigration services. Check with government authorities for legitimate licensing.",
              ...
              },
              {
                ...
                description:
                  "Scammers often become unresponsive after receiving payment, or provide fake contact information that becomes unreachable.",
              ...
              },
              {
                ...
                description:
                  "Legitimate companies give you time to make decisions. Be suspicious of high-pressure sales tactics or limited-time offers.",
              ...
              >
                <div
                  className={`relative h-full bg-gradient-to-br ${warning.bgColor} border-2 ${warning.borderColor} rounded-2xl p-6 lg:p-8 hover:shadow-xl transform hover:scale-105 transition-all duration-500`}
                >
                  {/* Warning Icon */}
                  <div className="text-center mb-6">
                    <div
                      className={`w-16 h-16 lg:w-20 lg:h-20 bg-gradient-to-r ${warning.color} rounded-2xl flex items-center justify-center text-3xl lg:text-4xl text-white shadow-2xl mb-4 mx-auto transform group-hover:scale-110 group-hover:rotate-6 transition-all duration-500`}
                    >
                      {warning.icon}
                    </div>
                  ...
                  <h3 className="text-xl lg:text-2xl font-bold text-gray-800 mb-4 group-hover:text-red-700 transition-colors duration-300">
                    {warning.title}
                  </h3>
                  ...
                  {/* Decorative Elements */}
                  <div className="absolute bottom-4 left-4 w-2 h-2 bg-red-400 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-500 animate-ping"></div>
                </div>
              </div>
            ))}
          </div>
          ...
          {/* Action Section */}
          <div
            className={`bg-white rounded-3xl shadow-2xl border border-gray-200 p-8 lg:p-12 transition-all duration-1000 ${
              visibleSections.includes("scam-awareness")
                ? "opacity-100 translate-y-0"
                : "opacity-0 translate-y-10"
            }`}
          ...
          >
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              {/* Left Side - Report Scam */}
              <div className="text-center lg:text-left">
                <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-r from-red-500 to-red-600 rounded-2xl mb-6 lg:mb-8">
                ...
                <p className="text-lg text-gray-600 mb-6 lg:mb-8 leading-relaxed">
                  Help protect others by reporting fraudulent immigration
                  companies. Your report can prevent others from falling victim
                  to the same scams.
                </p>

                <Link to="/report">
                  <Button className="w-full lg:w-auto bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white font-bold px-8 py-4 text-lg rounded-2xl shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300 group">
              ...
              {/* Right Side - Find Trusted Services */}
              <div className="text-center lg:text-left">
                <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-r from-green-500 to-green-600 rounded-2xl mb-6 lg:mb-8">
                ...
                <p className="text-lg text-gray-600 mb-6 lg:mb-8 leading-relaxed">
                  Browse our directory of verified and legitimate immigration
                  service providers. All businesses are vetted and licensed to
                  ensure your safety.
                </p>

                <Link to="/browse">
                  <Button className="w-full lg:w-auto bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white font-bold px-8 py-4 text-lg rounded-2xl shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300 group">
                    <span className="flex items-center justify-center gap-3">
            ...
            {/* Protection Tips */}
            <div className="mt-12 p-6 lg:p-8 bg-gradient-to-r from-blue-50 to-cyan-50 border border-blue-200 rounded-2xl">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {[
                  "Always verify company licenses with government authorities",
                  "Research companies online and check multiple review sources",
                  "Never pay large amounts upfront without proper documentation",
                  "Be wary of companies guaranteeing specific outcomes",
