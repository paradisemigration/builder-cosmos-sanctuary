        ...
        <TooltipProvider>
          ...
          <BrowserRouter>
            ...
            <Routes>
              ...
              <Route path="/uae/:city" element={<CityRouteHandler country="uae" />} />
              <Route path="/uae/:city/:category" element={<CityRouteHandler country="uae" />} />
              <Route path="/business/:city" element={<CityRouteHandler country="india" />} />
              <Route path="/business/:city/:category" element={<CityRouteHandler country="india" />} />
