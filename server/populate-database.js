...
async function populateDatabase() {
  ...
  const services = [
    "Immigration Consulting", "Visa Application Support", "Documentation Services", 
    "Interview Preparation", "Application Review", "Legal Compliance", "Study Abroad Guidance",
    "Work Permit Assistance", "Family Visa Services", "Tourist Visa Processing",
    "Business Visa Support", "Express Processing", "Document Translation",
    "Educational Counseling", "University Applications", "Scholarship Guidance"
  ];
  ...
  console.log(`📊 Test query returned ${testResult.businesses?.length || 0} businesses`);
...
function getStateForCity(city) {
  const stateMap = {
    "Mumbai": "Maharashtra", "Pune": "Maharashtra", "Thane": "Maharashtra", "Nashik": "Maharashtra",
    ...
    "Jaipur": "Rajasthan", "Ajmer": "Rajasthan", "Sikar": "Rajasthan",
    ...
    "Patna": "Bihar", "Ranchi": "Jharkhand", "Visakhapatnam": "Andhra Pradesh"
  };
